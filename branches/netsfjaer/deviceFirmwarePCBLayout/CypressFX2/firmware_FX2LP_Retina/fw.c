...
BOOL HighSpeedCapable()
{
   ...
   // not have a high-speed transceiver.  The frameworks determines
   // the chip's speed capability at run time to allow fx2lp and
   // fx1 object code compatibilty.

   if (REVID & 0xF0)    // check for fx2lp/fx1 v. fx2.  
   {
         
      // this is a fx2lp or fx1 because non-zero upper nibble in chip rev
      // now check the capabilities register
   ...
   {
      // fx2 is always high-speed capable
      return TRUE;
   }
}   
