...
public class CypressFX2 implements UsbIoErrorCodes, PnPNotifyInterface, AEMonitorInterface, ReaderBufferControl {
    ...
    /** Default firmware file for blank devices. This must be a bix (raw binary) firmware file, not an iic or hex file */
    private static String defaultFirmwareBixFileForBlankDevice=prefs.get("CypressFX2.defaultFirmwareBixFileForBlankDevice", null);
    
    /** filename of FX2 binary executable, generated by uVision project and associated script that runs hex2bix */
    public final static String FIRMWARE_FILENAME_TMPDIFF128_BIX = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAER_FX2LP_Retina.bix"; //"USBAEMonFirware.bin";
    /** filename of FX2 binary executable, generated by uVision project and associated script that runs hex2bix */
    public final static String FIRMWARE_FILENAME_TMPDIFF128_HEX = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAER_FX2LP_Retina.hex"; //"USBAEMonFirware.bin";
    /** filename of FX2 binary executable, generated by uVision project and associated script that runs hex2bix */
    public final static String FIRMWARE_FILENAME_MONITOR_SEQUENCER = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAERmini2.bix";
    /** filename of FX2 binary executable, generated by uVision project and associated script that runs hex2bix */
    public final static String FIRMWARE_FILENAME_MONITOR_SEQUENCER_HEX = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAERmini2.hex";
    /** filename of FX2 binary executable, generated by uVision project and associated script that runs hex2bix */
    public final static String FIRMWARE_FILENAME_MONITOR_SEQUENCER_IIC = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAERmini2.iic";
    public final static String FIRMWARE_FILENAME_MONITOR_SEQUENCER_JTAG_IIC = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAERmini2_JTAG.iic";
    public final static String FIRMWARE_FILENAME_MAPPER_IIC = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USB2AERmapper.iic";
    public final static String FIRMWARE_FILENAME_STEREO_IIC = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/TMPdiffStereo.iic";//    public final static String FIRMWARE_FILENAME_TCVS320_IIC="/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAERTCVS320.iic";
    public final static String FIRMWARE_FILENAME_TCVS320_HEX = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAERTCVS320.hex";
    public final static String FIRMWARE_FILENAME_TCVS320_BIX = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAERTCVS320.bix";
    public final static String FIRMWARE_FILENAME_DVS128_IIC = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/firmwareFX2_DVS128.iic";
    
    public final static String FIRMWARE_FILENAME_COCHLEAAMS_BIX = "/sf/net/jaer/hardwareinterface/usb/cypressfx2/firmwareFX2_Cochleaams1b.bix";
     ...
     * This VID/PID pair is used to indicate a blank device that needs programming. */
...
//        pnp.enablePnPNotification(GUID);
     ...
     * 
     * @param name the string. This string has very limited length, e.g. 4 bytes.
...
//        log.info("writing EEPROM to addr="+addr+" with "+bytes.length+" bytes");
     ...
     *@param DID the 'device' ID, can be used to individualize devices. This is not the same as the serial number, which by convention is the third string ID.
     */
...
//    }
     ...
     *that is included in the project jar. For example: "/sf/net/jaer/hardwareinterface/usb/cypressfx2/USBAER_FX2LP_Retina.hex"
...
//        set8051Reset(false);
     ...
     * device RAM and this is done automatically. The device is <strong>not configured by this method. Vendor requests and
...
//        System.out.println("CypressFX2RetinaBiasgen.unconfigureDevice()");
 ...
 //        String firmwareFilename = getFirmwareFilenameBinaryFromVIDPID();
        ...
        String firmwareFilename=getDefaultFirmwareBixFileForBlankDevice();
