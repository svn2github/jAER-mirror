...
/*##############################################################################
## FGPIO - Fast General Purpose I/O
##############################################################################*/
// for LPC2106/01 only
#define FGPIO_IODIR     (*(REG32 (0x3FFFC000))) // Alternate name FGPIO = FGPIO0
#define FGPIO_IOMASK    (*(REG32 (0x3FFFC010)))
#define FGPIO_IOPIN     (*(REG32 (0x3FFFC014)))
#define FGPIO_IOSET     (*(REG32 (0x3FFFC018)))
#define FGPIO_IOCLR     (*(REG32 (0x3FFFC01C)))

#define FGPIO_IODIR0    (*(REG32 (0x3FFFC000))) 
#define FGPIO_IOMASK0   (*(REG32 (0x3FFFC010)))
#define FGPIO_IOPIN0    (*(REG32 (0x3FFFC014)))
#define FGPIO_IOSET0    (*(REG32 (0x3FFFC018)))
#define FGPIO_IOCLR0    (*(REG32 (0x3FFFC01C)))
...
##############################################################################*/
// for LPC2106/01 only		   // WATCH OUT - THIS IS DIFFERENT TO LPC2101/02/03
#define SSP_CR0         (*(REG32 (0xE005C000)))
#define SSP_CR1         (*(REG32 (0xE005C004)))
#define SSP_DR          (*(REG32 (0xE005C008)))
#define SSP_SR          (*(REG32 (0xE005C00C)))
#define SSP_CPSR        (*(REG32 (0xE005C010)))
#define SSP_IMSC        (*(REG32 (0xE005C014)))
#define SSP_RIS         (*(REG32 (0xE005C018)))
#define SSP_MIS         (*(REG32 (0xE005C01C)))
#define SSP_ICR    		(*(REG32 (0xE005C020)))
