...
#define  EP1_PACKET_SIZE         0x0040  //' 64 Bytes per packet. This is the maximum EP1 packet(with doubleBuffering). Using other Endpoint?

// IMPORTANT- this should be Little-Endian version of EP1_PACKET_SIZE
#define  EP1_PACKET_SIZE_LE      0x4000

// Can range 0 - 1024 depending on data and transfer type
#define  EP2_PACKET_SIZE         0x0008

// IMPORTANT- this should be Little-Endian version of EP2_PACKET_SIZE
#define  EP2_PACKET_SIZE_LE      0x0800
...
//' Custom Vendor Requests for setting Biases etc.
#define VENDOR_REQUEST_START_STREAMING 0x1a 
#define VENDOR_REQUEST_STOP_STREAMING 0x1b 
#define VENDOR_REQUEST_SEND_BIASES 0x1c 
#define VENDOR_REQUEST_SET_DATA_TO_SEND 0x1d
#define VENDOR_REQUEST_REQUEST_FRAME 0x1e 
#define VENDOR_REQUEST_SEND_BIAS 0x1f 
#define VENDOR_REQUEST_SEND_ONCHIP_BIAS 0x20
#define VENDOR_REQUEST_SET_POWERDOWN_STATE 0x21
#define VENDOR_REQUEST_SET_DATA_TO_SEND_MDC2D 0x22 
...
#define AMX_VRECEP           0x0D  //' 00001101 P2.5
#define AMX_VLMC1            0x0E  //' 00001110 P2.6
#define AMX_VLMC2            0x0F  //' 00001111 P2.7


//' Descriptor Frame Flags: used to uondicate the position of each output channel in the Frame descriptor 
#define DESCR_FLAG_VRECEP      	0x04 //000 0100
#define DESCR_FLAG_VLMC1      	0x20 //001 0000
#define DESCR_FLAG_VLMC2     	0x40 //010 0000
#define DESCR_FLAG_BIT7			0x80//010 0000
...
void Adc_ConvComple_ISR(void);         // Upon Conversion, switch ADC MUX
