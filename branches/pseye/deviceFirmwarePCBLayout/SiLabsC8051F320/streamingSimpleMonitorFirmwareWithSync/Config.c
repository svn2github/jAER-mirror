// this file is modified from the config wizard output to not mess with clk settings so that USB still works
//---------------------------------------------------------------
...
// outputs.
    ...
    P0MDOUT = 0x02; // Output configuration for P0 
    P1MDOUT = 0x00; // Output configuration for P1 
    P2MDOUT = 0xC0; // Output configuration for P2 
...
// View port pinout
		...
		// Port 0
		// P0.0 = PCA CEX0        (Open-Drain Output/Input)(Digital)
		// P0.1 = GP I/O          (Push-Pull Output)(Digital)
		// P0.2 = GP I/O          (Open-Drain Output/Input)(Digital)
...
//----------------------------------------------------------------
    ...
    //Module 0
    PCA0CPM0 = 0x10;    // PCA Capture/Compare Register 0
