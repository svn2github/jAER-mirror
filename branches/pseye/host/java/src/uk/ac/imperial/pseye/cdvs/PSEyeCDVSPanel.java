 ...
 * @author mlk
 */
public class PSEyeCDVSPanel extends JPanel implements Observer {

    private final static Logger log = Logger.getLogger("PSEyeChipPanel");
    public PSEyeModelCDVS chip;
     ...
     */
    public PSEyeCDVSPanel(PSEyeModelCDVS chip) {
        this.chip = chip;
    ...
    synchronized private void setComponents() {
        ...
        Object[] models = chip.getModels().toArray();
        modelCB.setModel(new DefaultComboBoxModel(models));
        modelCB.setSelectedItem(chip.getColourModel());
        modelCB.setEnabled(models.length > 1);
        modelCB.setToolTipText(chip.getColourModel().description);
        dvsCB.setSelected(chip.getIsDVSShown());
   ...
   /** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        dvsCB = new javax.swing.JCheckBox();
        ...
        setMinimumSize(new java.awt.Dimension(300, 535));
        setPreferredSize(new java.awt.Dimension(300, 535));
        ...
        modelCB.setMaximumRowCount(30);
        modelCB.setMaximumSize(null);
        modelCB.setPreferredSize(null);
        ...
        jPanel4.add(modelCB, gridBagConstraints);
        ...
        dvsCB.setToolTipText("Show equivalent DVS events");
        dvsCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dvsCBActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        jPanel4.add(dvsCB, gridBagConstraints);
        ...
        offSp.getAccessibleContext().setAccessibleDescription("");
        ...
        onSp.getAccessibleContext().setAccessibleDescription("");

        onstdSp.setToolTipText("");
        ...
        onstdSp.getAccessibleContext().setAccessibleDescription("");

        offstdSp.setToolTipText("");
        ...
        offstdSp.getAccessibleContext().setAccessibleDescription("");
        ...
        gcCB.getAccessibleContext().setAccessibleDescription("");
        ...
        lcCB.getAccessibleContext().setAccessibleDescription("");
        ...
        itCB.getAccessibleContext().setAccessibleDescription("");
        ...
        bgSp.setToolTipText("Rate of ON events due to reset leakage");
    ...
    private void modelCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modelCBActionPerformed
        PSEyeModelCDVS.ColourModel model = (PSEyeModelCDVS.ColourModel) modelCB.getSelectedItem();
        chip.setColourModel(model);
    }//GEN-LAST:event_modelCBActionPerformed

    private void dvsCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dvsCBActionPerformed
        if (!refresh)
            chip.setIsDVSShown(dvsCB.isSelected());    }//GEN-LAST:event_dvsCBActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JSpinner bgSp;
    private javax.swing.JCheckBox dvsCB;
     ...
     */
    public void setChip(PSEyeModelCDVS chip) {
        this.chip = chip;
    }

    @Override
    public void update(Observable o, Object arg) {
        if (o != null && o == chip && arg instanceof PSEyeModelCDVS.EVENT_MODEL) {
