...
SENDBIT BIT 0xE0^0 ; this is the lsb we're sending now
...
jb SENDBIT, highbit ;if carry bit is high jump (jump if carry bit (msb) is set)
; bit is low
clr DATABIT
...
;nop
;nop
rr A ;rotate left through carry
