...
// IO Drive Strengths
#define FX3_DRIVE_STRENGTH_PPORT (CY_U3P_DS_THREE_QUARTER_STRENGTH)
#define FX3_DRIVE_STRENGTH_I2C (CY_U3P_DS_THREE_QUARTER_STRENGTH)
#define FX3_DRIVE_STRENGTH_SPI (CY_U3P_DS_THREE_QUARTER_STRENGTH)
