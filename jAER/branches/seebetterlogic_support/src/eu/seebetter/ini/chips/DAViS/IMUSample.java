...
public class IMUSample extends ApsDvsEvent {
	 ...
	 *
	 * @param aFullScaleAccelG
	 *            the fullScaleAccelG to set
	 */
	 ...
	 * Changes full scale value constant. Note that this only changes scaling, not the IMU itself.
	 *
	 * @param aFullScaleGyroDegPerSec
	 *            the fullScaleGyroDegPerSec to set
	 */
	...
	/**
	 * @param aAccelSensitivityScaleFactorGPerLsb
	 *            the accelSensitivityScaleFactorGPerLsb to set
	 */
	...
	/**
	 * @param aGyroSensitivityScaleFactorDegPerSecPerLsb
	 *            the gyroSensitivityScaleFactorDegPerSecPerLsb to set
	 */
	 ...
	 *            timestamp
	 * @param buf
	 *            short array with 7 measurements from IMU Sensor
	 *
	 */
		...
		if (imuSampleEvent) {
			return String
				.format(
					...
					imuSampleEvent, getTimestampUs(), deltaTimeUs, getAccelX(), getAccelY(), getAccelZ(),
