...
# note, that with this you allow everybody to access your usb ports (devmode=0666)
...
then
	...
	echo "please run 'sudo mount -t usbfs usbfs /proc/bus/usb -o devmode=0666' before running this script for the first time. this will install the usbfs filesystem needed by the linux driver'"
fi
