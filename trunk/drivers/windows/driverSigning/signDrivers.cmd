...
rem set d=%root%\x32
rem Inf2Cat.exe /driver:%d% /os:XP_X86,Vista_X86,7_X86 /verbose
rem signtool sign /v /n "iniLabs GmbH" /ac MSCV-GlobalSign.cer /t http://timestamp.verisign.com/scripts/timestamp.dll %d%\usb2aemon.cat
