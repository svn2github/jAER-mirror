...
-- Module  Version: 5.4
--E:\LatticeDiamond\diamond\2.0\ispfpga\bin\nt64\scuba.exe -w -n AERfifo -lang vhdl -synth synplify -bus_exp 7 -bb -arch mj5g00 -type ebfifo -depth 1024 -width 16 -rwidth 16 -no_enable -pe 10 -pf 252 -e 

-- Thu Dec 13 14:07:25 2012
...
architecture Structure of AERfifo is
    ...
    attribute AEPOINTER1 of AERfifo_0_1 : label is "0b00000001011111";
    attribute AEPOINTER of AERfifo_0_1 : label is "0b00000001010111";
    ...
    attribute DATA_WIDTH_R of AERfifo_0_1 : label is "9";
    ...
    attribute DATA_WIDTH_R of AERfifo_1_0 : label is "9";
...
begin
    ...
    AERfifo_0_1: FIFO8KA
        ...
        AEPOINTER1=> "00000001011111", AEPOINTER=> "00000001010111", 
        RESETMODE=> "ASYNC", REGMODE=> "NOREG", CSDECODE_R=> "11", 
        CSDECODE_W=> "11", DATA_WIDTH_R=>  9, DATA_WIDTH_W=>  9)
        -- synopsys translate_on
    ...
    AERfifo_1_0: FIFO8KA
        ...
        port map (DI0=>Data(9), DI1=>Data(10), DI2=>Data(11), 
            ...
            DO5=>Q(14), DO6=>Q(15), DO7=>open, DO8=>open, DO9=>open, 
