...
#Begin clock constraint
define_clock -name {USBAER_top_level|IfClockxCI} {p:USBAER_top_level|IfClockxCI} -period 8.955 -clockgroup Autoconstr_clkgroup_1 -rise 0.000 -fall 4.478 -route 0.000 
#End clock constraint
