...
#define FX3_STATUS_DMA_CPUTOUSB_BUF_COUNT (1)
...
#define FX3_FIFO_DATA_DMA_FX3TOUSB_BURST_LEN (4)
#define FX3_FIFO_DATA_DMA_FX3TOUSB_BUF_COUNT (4)
...
#define FX3_FIFO_DATA_DMA_USBTOFX3_BURST_LEN (4)
#define FX3_FIFO_DATA_DMA_USBTOFX3_BUF_COUNT (4)
