...
{  
	...
	timer_init(); // start the timer2 to run imuTimestamp timer ASAP
...
// T2CON.6 (EXF2)
// IE.5 IP.5 6 0x002B
void ISR_Timer2(void) interrupt 5 // http://www.keil.com/support/man/docs/c51/c51_le_interruptfuncs.htm, for vector address 0x002b
{
