...
public class FilterFrame<PanelType extends FilterPanel> extends javax.swing.JFrame implements PropertyChangeListener, WindowSaver.DontResize {
    ...
    private void initComponents() {
        ...
        resetPerformanceMeasurementCBMI = new javax.swing.JCheckBoxMenuItem();
        ...
        resetPerformanceMeasurementCBMI.setMnemonic('s');
        resetPerformanceMeasurementCBMI.setText("Reset performance measurement statistics");
        resetPerformanceMeasurementCBMI.setToolTipText("Enables instrumentation of filter performance");
        resetPerformanceMeasurementCBMI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                resetPerformanceMeasurementCBMIActionPerformed(evt);
            }
        });
        modeMenu.add(resetPerformanceMeasurementCBMI);
    ...
    private void resetPerformanceMeasurementCBMIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetPerformanceMeasurementCBMIActionPerformed
        if(filterChain!=null) filterChain.resetResetPerformanceMeasurementStatistics();
    }//GEN-LAST:event_resetPerformanceMeasurementCBMIActionPerformed
    ...
    private javax.swing.JCheckBoxMenuItem resetPerformanceMeasurementCBMI;
